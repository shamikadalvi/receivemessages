...
<div class="tab1">
  ...
  <button class="tablinks1" onclick="openCity1(event, 'FACTS')">FACTS</button>
   <button class="tablinks1" onclick="openCity1(event, 'INFORMATION')">INFORMATION</button>
</div>
...
<div class="w3-content w3-section" style="max-width:500px">
  <img class="mySlides" src="cube1.jpg" style="width:100%">
  <img class="mySlides" src="cube2.jpg" style="width:100%">
  <img class="mySlides" src="cube3.jpg" style="width:100%">
</div>  
