...
<div class="tab1">
  ...
  <button class="tablinks1" onclick="openCity1(event, 'FACTS')">FACTS</button>
   <button class="tablinks1" onclick="openCity1(event, 'PRODUCT')">PRODUCT</button>
</div>
...
<div id="PRODUCT" class="tabcontent1">
...
<td>  Rubik's Cube </td>
<td> RS 20 <input type="hidden" name="TXN_AMOUNT"  value="20"></td>
