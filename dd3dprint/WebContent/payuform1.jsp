...
%>
<% 	
	String merchant_key="smR7qBii";
	String salt="7o1wM1579Q";
	String action1 ="";
...
<input type="hidden" name="key" value="<%= merchant_key %>" />
      ...
      <table>
        ...
        <tr>
          <td>Amount: </td>
         <td> 
         <input type="checkbox" name="amount" value="500" checked>500
        ...
        <tr>
          <td>Success URI: </td>
           ...
           <td> 
         <input type="checkbox" name="surl" value="http://www.cubeminx.com" checked>http://www.cubeminx.com
        ...
        <tr>
          <td>Failure URI: </td>
            <td> 
         <input type="checkbox" name="furl" value="http://www.cubeminx.com" checked>http://www.cubeminx.com
