6<%@page import="paytm_java.PaytmConstants"%>
...
parameters.put("EMAIL","shamika1994@gmail.com");
parameters.put("CALLBACK_URL", "http://www.cubeminx.com/dummy46.htm");
//parameters.put("CALLBACK_URL", "http://localhost:8082/website/dummy46.htm");
...
System.out.println("reached here to pgDirect");
%>
