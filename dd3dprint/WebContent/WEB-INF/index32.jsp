...
<div class="tab">
  ...
  <button class="tablinks" onclick="openCity(event, 'London')" id="defaultOpen">Oled Displaying Images</button>
   <button class="tablinks" onclick="openCity(event, 'Paris')">Oled on Raspberrypi using java</button>
  ...
  <button class="tablinks" onclick="openCity(event, 'Mulund')">Rubik's cube Theme Ganpati Decoration</button>
...
<div id="Paris" class="tabcontent">
  <h3>Oled on Raspberrypi using java</h3>
  <p>
  <br>
...
<div id="Mulund" class="tabcontent">
   <h3>Rubik's cube theme ganpati decoration</h3>
  
  <iframe width="500" height="300" src="https://www.youtube.com/embed/EZ_yq_PrYxY" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
  <br>
  <p>
  <pre>
  
 The structure has 486 led's which are coded using arduino mega
 to depict the actual moves on Rubik's cube
 We have also fed 20 different patterns 
