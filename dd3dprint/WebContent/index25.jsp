...
<div id="Delhi" class="tabcontent">
  ...
  method.It solves the corner first and then edges using only 
  2 algorithms The T perm and Ya Perm.And displays the set of 
  moves in the console
  
  The UI o/p displays the cube in 2D as the algorithm progresses
  from solving the corners to solving the edges that finally 
  solves the cube.
